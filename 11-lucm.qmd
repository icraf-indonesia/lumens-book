...
4.  **Set Repetition Number**:
    ...
    -   Enter the *number of iterations* for the simulation in the *"Repetition"* field.
        This value determines how many iterations the model will run to generate reliable projections.
