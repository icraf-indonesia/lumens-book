...
The LaSEM module report consists of 4 main sections: suitability map, suitability map by factors, attribute table and download results.

**Section 1: Suitability Map**
...
**Section 2: Suitability Map by Factors**
...
**Section 3: Attribute Table**

This section presents the crop suitability in tabular form.
Users can find the actual crop suitability results in the **suitability** column, presenting the values N to S1.
The succeeding columns, **limiting_factor_actual** and **limiting_factor_potential**, shows what parameter has the lowest value that leads to the given results.

As the intervention increases, the suitability value changes into suitability potential, which is shown in columns **suitability_potential_low, suitability_potential_med,** and **suitability_potential_high.**
...
Ensuring ood security relies heavily on the availability of sustainable lands for agriculture.
